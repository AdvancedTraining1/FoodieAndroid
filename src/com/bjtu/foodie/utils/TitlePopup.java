...
public class TitlePopup extends PopupWindow{
    ...
    public TitlePopup(Context context, int width, int height){  
        ...
        //设置弹窗的布局界面
        setContentView(LayoutInflater.from(mContext).inflate(R.layout.activity_title_popup, null));  
    ...
    private void initUI(){
        ...
        mListView.setOnItemClickListener(new OnItemClickListener() {  
            ...
            public void onItemClick(AdapterView<?> arg0, View arg1, int index,long arg3) {  
                ...
                if(mItemOnClickListener != null){
                	...
                	Log.i(Constants.TAG_MOMENT, "click"+index);
                }
                    
            }  
        });
        linearLike = (LinearLayout) getContentView().findViewById(R.id.linear_like);
        linearComment = (LinearLayout) getContentView().findViewById(R.id.linear_comment);
        linearLike.setOnClickListener(new OnClickListener() {
			@Override
			public void onClick(View arg0) {
				// TODO Auto-generated method stub
				Log.i(Constants.TAG_MOMENT, "like!!");
			}
		});
        linearComment.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View arg0) {
				// TODO Auto-generated method stub
				Log.i(Constants.TAG_MOMENT, "comment!!");
				dismiss();
    ...
    public void show(View view){  
        ...
        //显示弹窗的位置
        Log.i(Constants.TAG_MOMENT,";"+mScreenWidth+";"+getWidth()+";"+mRect.bottom);
//        showAtLocation(view, popupGravity, mScreenWidth - LIST_PADDING - (getWidth()/2), mRect.bottom);
        showAtLocation(view, popupGravity, 480, mRect.bottom-50);
    }  
