...
import com.bjtu.foodie.adapter.FullMyDateItemAdapter;
...
public class MyDateActivity extends Activity {
	...
	private FullMyDateItemAdapter dateAdapter;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		list_dates = getMyDates();
		dateAdapter = new FullMyDateItemAdapter(this, list_dates);

		lv_allDates.setAdapter(dateAdapter);
		
	}

	public ArrayList<JSONObject> getMyDates(){
	 ...
	 if(LoginActivity.token != null){
		...
		String urlString="/service/date/lookown?token="+tokenString;
		try {
